...
import com.example.policy.response.enums.ErrorEnum;
import lombok.Data;
...
public class AjaxResult<T> {
    ...
    public static <T> AjaxResult<T> successs(T data) {
        return new AjaxResult<>(ErrorEnum.SUCCESS.getCode(), ErrorEnum.SUCCESS.getMsg(), data);
    }
     ...
     * @return AjaxResult
     */
    public static <T> AjaxResult<T> failedWithType(String msg) {
        return new AjaxResult<T>(ErrorEnum.FAILED.getCode(), msg, null);
    }
     ...
     * @author fzr
     */
    public static <T> AjaxResult<T> fail(ErrorEnum errorEnum) {
        return new AjaxResult<T>(errorEnum.getCode(), errorEnum.getMsg(), null);
    }
     ...
     * @author fzr
     */
    public static <T> AjaxResult<T> failed(ErrorEnum errorEnum, String msg) {
        return new AjaxResult<T>(errorEnum.getCode(), msg, null);
    }
